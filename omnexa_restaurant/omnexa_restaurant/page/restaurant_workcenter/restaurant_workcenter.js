frappe.pages["restaurant-workcenter"].on_page_load = function (wrapper) {
	if (window.omnexa_core && omnexa_core.vertical_workcenter && omnexa_core.vertical_workcenter.mount) {
		omnexa_core.vertical_workcenter.mount(wrapper, "omnexa_restaurant");
		return;
	}
	const page = frappe.ui.make_app_page({
		parent: wrapper,
		title: __("Restaurant Workcenter"),
		single_column: true,
	});
